  ...
  const currentItems = getTableData?.slice(offset, offset + itemsPerPage).map((t, i) => {
    return (
      <tr>
        ...
        <td className='text-center' style={{ display: "flex", gap: "10px" }}>
          <span style={{ color: "#299205" }}><MdOutlineRemoveRedEye onClick={previewHandler} /></span>
        ...
        <td><span> <HiOutlineDotsVertical /> </span></td>
      </tr>
    )
  });
        ...
        <div className='heading'>
          ...
          <div className='search_tables'>
            <div>
              ...
              <svg onClick={searchHandler} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
